...
(function (w) {
    ...
    checkPhone.addEventListener('click', function () {
      if (!this.checked) {
        ...
        addHtmlNodes(phoneWrap, '(11) 3382-1550', 'phone');
      }
    });
    ...
    function createBanner(src) {
      ...
      img.src = src ? src : 'https://cdn.statically.io/gh/devrmg/image/main/papel%20de%20parede%20(1).png';
